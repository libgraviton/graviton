 ...
 */
class VersioningServiceBuilder extends RuntimeDefinitionBuilderAbstract
{
    ...
    {
        $data->runtimeDefinition->setIsVersioned(
            $data->definition->isVersionedService()
        );
    }
}
