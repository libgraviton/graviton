...
class GenerateBundleCommand extends SymfonyGenerateBundleCommand
{
     ...
     * @return string[]
     */
    protected function updateKernel(DialogHelper $dialog, InputInterface $input, 
        OutputInterface $output, KernelInterface $kernel, $namespace, $bundle)
    {
        ...
        if ($input->isInteractive()) {
            $auto = $dialog->askConfirmation($output, 
                $dialog->getQuestion(
                    'Confirm automatic update of your core bundle', 'yes', '?'), 
                true);
        }
     ...
     * @return string[]
     */
    protected function updateRouting(DialogHelper $dialog, InputInterface $input, 
